...
We're working hard to make *bitcore* the most powerful JavaScript library for working with but. Our goal is to have *but* be a library that can be used by anyone interested in but, and to level expertise differences with great design and documentation.
