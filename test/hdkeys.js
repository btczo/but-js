...
var HDPublicKey = but.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = but.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(but.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(but.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      but.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = but.PublicKey.fromPoint;
      but.PublicKey.fromPoint = function() {
        but.PublicKey.fromPoint = unstubbed;
